...
class AuthController extends GetxController {
  ...
  Future<void> login(BuildContext context) async {
    if (await loginValidateFields(context)) {
      ...
      // ✅ Check for hardcoded admin credentials before Firebase Auth
      if (authEmailAddress == "admin@gmail.com" && authPassword == "11111111") {
        isLoading.value = false;
        buildScaffoldSuccessMessage(context, 'Welcome Admin!');
        clearController();
        Get.offNamed(AppRouter.ADMIN_DRAWER); // Navigate to admin screen
        return;
      }
